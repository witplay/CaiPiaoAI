...
def caiscq():
    ...
    try:
        ...
        sup.dset.guid = '3322604ce1a811f0bcf3688fc99b9eb0'  # 如果为all时所有都测试，
        sup.dset.IsFix = True
        fixfor = 10  # 循环训练几次
        sup.dset.isClassFix =  True#二维入参
        ...
        sup.dset.metrics_name = "cailoss2"  # mape、cailoss、
        sup.dset.PrintType = "cai"  # 输出类型
